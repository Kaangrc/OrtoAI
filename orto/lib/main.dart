  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        routes: {
          ...
          '/doctor/profile': (context) => const DProfilePage(),
          '/doctor/team': (context) => const DTeamPage(),
          '/doctor/files': (context) => const DFilePage(),
          '/doctor/forms': (context) => const DFormPage(formId: ''),
          '/doctor/patients': (context) => const DPatientPage(),
        },
        theme: lightMode,
        darkTheme: darkMode,
